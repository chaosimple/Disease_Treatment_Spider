...
class RenQun(Base):
    ...
    def __repr__(self):
        """"""
        return "RenQun < %s >" % self.Name.encode('gbk', 'ignore')
...
class KeShi(Base):
    ...
    def __repr__(self):
        """"""
        return "KeShi < %s >" % self.Name.encode('gbk', 'ignore')
...
class BuWei(Base):
    ...
    def __repr__(self):
        """"""
        return "Buwei < %s >" % self.Name.encode('gbk', 'ignore')
...
class JiBing(Base):
    ...
    def __repr__(self):
        """"""
        return "JiBing < %s >" % self.Name.encode('gbk', 'ignore')
...
class ZhengZhuang(Base):
    ...
    def __repr__(self):
        """"""
        return "ZhengZhuang < %s >" % self.Name.encode('gbk', 'ignore')
...
if __name__ == '__main__':
    ...
    j = ss.query(JiBing).filter(JiBing.Name==u'O型腿').one()
    print 'over!'